function  par = function_parameters_NMPC_MD_gaslift
%% Control parameters
...
%% Initial conditions
% Initial input
par.Qginj0 = 662.5255;        % Injected gas flow rate [MV] (cm3/s)

% Initial states
par.mg0 = 1.5111;             % Initial gas mass (g)
par.ml0 = 1031.2674;          % Initial liquid mass (g)

%function_align_comments('function_parameters_NMPC_MD_gaslift.m', 40)
