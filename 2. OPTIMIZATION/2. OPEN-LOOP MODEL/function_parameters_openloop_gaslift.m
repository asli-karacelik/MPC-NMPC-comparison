function  par = function_parameters_openloop_gaslift
%% Input parameter (cm3/s)
par.Qginj = 2108.813609;
...
%function_align_comments('function_parameters_openloop_gaslift.m', 40)
