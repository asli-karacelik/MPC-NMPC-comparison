function  par = function_parameters_opt_gaslift
%% Control parameters
% Horizon steps
par.prediction_horizon = 100;             
par.control_horizon = 20;                

% Simulation parameters (s)
par.sample_time = 0.05; 
par.simulation_time = 1000; 
...
%% Initial conditions
% Initial input
par.Qginj0 = 0;        % Injected gas flow rate [MV] (cm3/s)

% Initial states
par.mg0 = 2.3427;            % Initial gas mass (g)
par.ml0 = 215.8352;          % Initial liquid mass (g)
 
% align_comments('function_parameters_NMPC_opt_gaslift.m', 40)
