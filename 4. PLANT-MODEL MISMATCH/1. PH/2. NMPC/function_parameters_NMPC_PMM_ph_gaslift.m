function  par = function_parameters_NMPC_PMM_ph_gaslift
%% Control parameters
...
%% Initial conditions
% Initial input
par.Qginj0 = 2889.12904914550; % Injected gas flow rate [MV] (cm3/s)

% Initial states
par.mg0 = 1.82187030618605;   % Gas mass (g)
par.ml0 = 796.641796574683;   % Liquid mass (g)
 
% function_align_comments('function_parameters_NMPC_PMM_ph_gaslift.m', 30)
