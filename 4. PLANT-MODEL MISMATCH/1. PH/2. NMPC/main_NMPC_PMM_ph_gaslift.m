...
%% Get parameters.
par = function_parameters_NMPC_PMM_ph_gaslift;

% % Store parameters in an Excel file
% T = {'Run', 'Sample Time (s)', 'Prediction Horizon', 'Control Horizon', 'Covariance Matrix (Q)', 'Comment'};
% writecell(T, 'parameters_NMPC_PMM_ph_gaslift.xlsx', 'Sheet', 1, 'Range', 'A1:F1');
% T = table({'1'}, par.sample_time, par.prediction_horizon, par.control_horizon);
% writetable(T, 'parameters_NMPC_PMM_ph_gaslift.xlsx', 'Sheet', 1, 'WriteVariableNames', 0, 'Range', 'A2:D2');
% % winopen('parameters_NMPC_PMM_gaslift.xlsx')
...
nlobj.Model.StateFcn = 'function_state_continuous_PMM_ph_gaslift';
nlobj.Model.OutputFcn = 'function_output_PMM_ph_gaslift';
...
% savefig(fig, 'fig14_NMPC_PMM_ph_Ts0_01_ph10_ch2_Q5_gaslift.fig') 
% close(fig)
