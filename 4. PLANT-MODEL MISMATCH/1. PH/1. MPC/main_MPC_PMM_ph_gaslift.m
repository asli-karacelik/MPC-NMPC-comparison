...
%% Get parameters.
par = function_parameters_MPC_PMM_ph_gaslift;

% % Store parameters in an Excel file
% T = {'Run', 'Sample Time (s)', 'Prediction Horizon', 'Control Horizon', 'Covariance Matrix (Q)', 'Comment'};
% writecell(T, 'parameters_MPC_PMM_ph_gaslift.xlsx', 'Sheet', 1, 'Range', 'A1:F1');
% T = table({'1'}, par.sample_time, par.prediction_horizon, par.control_horizon);
% writetable(T, 'parameters_MPC_PMM_ph_gaslift.xlsx', 'Sheet', 1, 'WriteVariableNames', 0, 'Range', 'A2:D2');
...
plant_model = 'model_PMM_ph_gaslift';
sim(plant_model)
...
% savefig(fig, 'fig14_MPC_PMM_ph_Ts0_01_ph10_ch2_gaslift.fig') 
% close(fig)
