function dxdt = function_state_continuous_PMM_ml_gaslift(x, u) 
...
ml = x(2) * 0.9;               % Liquid mass in the pipe (g)
...
dxdt(2) = wlin - wlout;       % Rate of change of liquid (g/s) --> (wlin - wlout) changed to 50 * (wlin - wlout)
