function  par = function_parameters_NMPC_PMM_ml_gaslift
%% Control parameters
...
%% Initial conditions
% Initial input
par.Qginj0 = 10.24; % Injected gas flow rate [MV] (cm3/s)

% Initial states
par.mg0 = 1.35;   % Gas mass (g)
par.ml0 = 1274.26;   % Liquid mass (g)
 
% function_align_comments('function_parameters_NMPC_PMM_ml_gaslift.m', 30)
