...
%% Get parameters.
par = function_parameters_NMPC_PMM_mg_gaslift;

% % Store parameters in an Excel file
% T = {'Run', 'Sample Time (s)', 'Prediction Horizon', 'Control Horizon', 'Comment'};
% writecell(T, 'parameters_NMPC_PMM_mg_gaslift.xlsx', 'Sheet', 1, 'Range', 'A1:D1');
% T = table({'4'}, par.sample_time, par.prediction_horizon, par.control_horizon);
% writetable(T, 'parameters_NMPC_PMM_mg_gaslift.xlsx', 'Sheet', 1, 'WriteVariableNames', 0, 'Range', 'A5:D5');
% winopen('parameters_NMPC_PMM_mg_gaslift.xlsx')
...
nlobj.Model.StateFcn = 'function_state_continuous_PMM_mg_gaslift';
nlobj.Model.OutputFcn = 'function_output_PMM_mg_gaslift';
...
savefig(fig, 'fig20_NMPC_PMM_mg_Ts0_1_ph10_ch2_QTs2_Euler100_gaslift.fig') 
close(fig)
